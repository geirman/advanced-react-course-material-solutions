  ...
  render() {
    ...
    return (
      <div className={`App ${color}-bg`}>
        ...
        >
          <TabList>
            <Tab><FaAutomobile className={currentTab === 0 ? COLORS[currentTab] : ''}/></Tab>
            <Tab><FaBed className={currentTab === 1 ? COLORS[currentTab] : ''}/></Tab>
            <Tab><FaPlane className={currentTab === 2 ? COLORS[currentTab] : ''}/></Tab>
            <Tab><FaSpaceShuttle className={currentTab === 3 ? COLORS[currentTab] : ''}/></Tab>
          </TabList>
          <TabPanels>
